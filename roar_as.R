...
# 1) Read in data files -----------
roar_sona_jan25 <- read_csv(here("mw2425_06data/ameliaSimmonds/data_exp_202242-v3_20250130", "data_exp_202242-v3_task-drj1.csv"))
roar_sl_jan25 <- read_csv(here("mw2425_06data/ameliaSimmonds/data_exp_195194-v10_20250130", "data_exp_195194-v10_task-drj1.csv"))

# 2) For first data file -----------
nsub <- check.n(roar_sona_jan25) # check number of participants in data file
roar_dat <- clean.roar(roar_sona_jan25) # first data file: pivot, select and rename relevant variables

# 3) For subsequent data files -----------

## roar_sl_jan25
n <- check.n(roar_sl_jan25) # check number of participants in data file
temp <- clean.roar(roar_sl_jan25) # subsequent data files: pivot, select and rename relevant variables
...
# 5) Save results in new data file ---------
write_csv(roar_score, here("mw2425_06data/ameliaSimmonds/mw2425_as_processed", "roar_score_20250130.csv"))

test <- read_csv(here("mw2425_06data/ameliaSimmonds/mw2425_as_processed", "roar_score_20250130.csv"))

##### Some preliminary analyses
roar_dat <- read_csv(here("mw2425_06data/ameliaSimmonds/mw2425_as_processed", "roar_score_20250130.csv")) %>%
